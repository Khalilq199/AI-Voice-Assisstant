...
class AssistantFnc(llm.FunctionContext):
    def __init__(self):
        ...
        # storing some context here about the car that the user is talking about
        # creating a private member fo this class
        self._car_details = {
            CarDetails.VIN: "",
            CarDetails.Make: "",
            CarDetails.Model: "",
    ...
    # tool available to the ai, read by model to tell if it should use the function or not
    ...
    # seeing if we have a vin and if we have a car
    def has_car(self):
