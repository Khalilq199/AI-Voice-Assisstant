...
# representing information I wanna store in my data base
@dataclass
class Car:
    vin: str
    make: str
...
class DatabaseDriver:
    ...
    def _init_db(self):
        with self._get_connection() as conn:
            ...
            # Create cars table if it does not already exist
            cursor.execute("""
    ...
    #ability to get a new car's VIN
